document.addEventListener('DOMContentLoaded', function() {
    ...
    playlistButtons.forEach(function(button) {
      button.addEventListener('click', function(event) {
        ...
        playlistFrame.innerHTML = `<iframe style="border-radius:12px" src="${playlistUrl}" width="95%" height="405" frameborder="0" allowtransparency="true" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>`;
      });
    });
  });
